...
Описание и стек каждого проекта — в его README: [Основной сайт](../admin-panel-golang/README.md) (или `go-angular-pg`), [Фронт Привычки](../frontend/README.md), [API Привычки](../backend/README.md) (или `habits-api`).
